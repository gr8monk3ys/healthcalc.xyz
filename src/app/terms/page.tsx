    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          ...
          KIND, EITHER EXPRESS OR IMPLIED. FATCALC DISCLAIMS ALL WARRANTIES, INCLUDING IMPLIED WARRANTIES 
          OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
        </p>
        <p className="mb-4">
          FATCALC DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED OR ERROR-FREE, THAT DEFECTS 
          WILL BE CORRECTED, OR THAT THE SERVICE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF 
          VIRUSES OR OTHER HARMFUL COMPONENTS.
        </p>
        <p>
          FATCALC MAKES NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE 
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          IN NO EVENT WILL FATCALC, ITS AFFILIATES, OR THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, 
