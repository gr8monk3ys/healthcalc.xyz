...
const COPY: Record<SupportedLocale, HubPageCopy> = {
  en: {
    metaFallbackTitle: 'Calculator Category | HealthCalc',
    metaFallbackDescription: 'Browse HealthCalc calculators by category.',
    breadcrumbCalculators: 'Calculators',
    title: hubTitle => `${hubTitle} Calculators`,
    metaTitle: hubTitle => `${hubTitle} Calculators | HealthCalc`,
    viewDetails: 'View details',
    browseAllCategories: 'Browse all categories →',
  },
  es: {
    metaFallbackTitle: 'Categoría de calculadoras | HealthCalc',
    metaFallbackDescription: 'Explora calculadoras de HealthCalc por categoría.',
    breadcrumbCalculators: 'Calculadoras',
    title: hubTitle => `Calculadoras de ${hubTitle}`,
    metaTitle: hubTitle => `Calculadoras de ${hubTitle} | HealthCalc`,
    viewDetails: 'Ver detalles',
    browseAllCategories: 'Ver todas las categorías →',
  },
  fr: {
    metaFallbackTitle: 'Catégorie de calculateurs | HealthCalc',
    metaFallbackDescription: 'Parcourez les calculateurs HealthCalc par catégorie.',
    breadcrumbCalculators: 'Calculateurs',
    title: hubTitle => `Calculateurs de ${hubTitle}`,
    metaTitle: hubTitle => `Calculateurs de ${hubTitle} | HealthCalc`,
    viewDetails: 'Voir les détails',
    browseAllCategories: 'Voir toutes les catégories →',
  },
  de: {
    metaFallbackTitle: 'Rechner-Kategorie | HealthCalc',
    metaFallbackDescription: 'Durchsuchen Sie HealthCalc-Rechner nach Kategorie.',
    breadcrumbCalculators: 'Rechner',
    title: hubTitle => `${hubTitle} Rechner`,
    metaTitle: hubTitle => `${hubTitle} Rechner | HealthCalc`,
    viewDetails: 'Details ansehen',
    browseAllCategories: 'Alle Kategorien ansehen →',
  },
  pt: {
    metaFallbackTitle: 'Categoria de calculadoras | HealthCalc',
    metaFallbackDescription: 'Navegue pelas calculadoras da HealthCalc por categoria.',
    breadcrumbCalculators: 'Calculadoras',
    title: hubTitle => `Calculadoras de ${hubTitle}`,
    metaTitle: hubTitle => `Calculadoras de ${hubTitle} | HealthCalc`,
  ...
  zh: {
    metaFallbackTitle: '计算器分类 | HealthCalc',
    metaFallbackDescription: '按类别浏览 HealthCalc 计算器。',
    breadcrumbCalculators: '计算器',
    title: hubTitle => `${hubTitle}计算器`,
    metaTitle: hubTitle => `${hubTitle}计算器 | HealthCalc`,
    viewDetails: '查看详情',
