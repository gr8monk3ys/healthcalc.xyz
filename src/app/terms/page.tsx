  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          Welcome to HealthCheck. These Terms of Service ("Terms") govern your access to and use of the 
          HealthCheck website, including any content, functionality, and services offered on or through 
          the website (the "Service").
        </p>
        <p>
          Please read these Terms carefully before using our Service. By accessing or using the Service, 
          you agree to be bound by these Terms. If you do not agree to these Terms, you must not access 
          or use the Service.
        </p>
      </div>
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          ...
          you represent and warrant that you are at least 13 years old. If you are under 18, you should 
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li>Impersonate or attempt to impersonate HealthCheck, a HealthCheck employee, or another user</li>
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          ...
          thereof) are owned by HealthCheck, its licensors, or other providers of such material and are 
          protected by copyright, trademark, and other intellectual property laws.
        </p>
        <p className="mb-4">
          You may use the Service for your personal, non-commercial use only. You must not reproduce, 
          distribute, modify, create derivative works of, publicly display, publicly perform, republish, 
          download, store, or transmit any of the material on our Service, except as follows:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        <p>
          ...
          permission from HealthCheck by contacting us at info@healthcheck.com.
        </p>
      </div>
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          ...
          KIND, EITHER EXPRESS OR IMPLIED. healthcheck DISCLAIMS ALL WARRANTIES, INCLUDING IMPLIED WARRANTIES 
          OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
        </p>
        <p className="mb-4">
          healthcheck DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED OR ERROR-FREE, THAT DEFECTS 
          WILL BE CORRECTED, OR THAT THE SERVICE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF 
          VIRUSES OR OTHER HARMFUL COMPONENTS.
        </p>
        <p>
          healthcheck MAKES NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE 
          CONTENT ON THE SERVICE OR THE CONTENT OF ANY WEBSITES LINKED TO THE SERVICE.
        </p>
      </div>
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p className="mb-4">
          IN NO EVENT WILL healthcheck, ITS AFFILIATES, OR THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, 
          AGENTS, OFFICERS, OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, 
          ARISING OUT OF OR IN CONNECTION WITH YOUR USE, OR INABILITY TO USE, THE SERVICE, INCLUDING 
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p>
          You agree to defend, indemnify, and hold harmless HealthCheck, its affiliates, licensors, and 
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p>
          ...
          California, without giving effect to any principles of conflicts of law. Any legal action or 
          proceeding relating to your access to or use of the Service shall be instituted in a state or 
          federal court in San Francisco County, California, and you agree to submit to the personal 
      ...
      <div className="neumorph p-6 mb-8 rounded-lg">
        ...
        <p>
          ...
          on our website, with the "Last Updated" date. If a revision meaningfully reduces your rights, 
          we will notify you (by, for example, posting a notice on our website or sending you an email). 
      ...
      <div className="neumorph p-6 rounded-lg">
        ...
        <p>
          If you have any questions about these Terms, please contact us at legal@healthcheck.com.
        </p>
      </div>
    </div>
  );
