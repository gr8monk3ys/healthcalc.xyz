...
/**
 * Non-default locale dictionaries. Import only from server code (the root
 * layout's providers pass the active dictionary down as a prop), so these
 * strings never enter the shared client bundle.
 */
export const LOCALE_MESSAGES: Record<Exclude<SupportedLocale, 'en'>, LocaleMessages> = {
  es: {
