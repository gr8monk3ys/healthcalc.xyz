...
const BodyFatInfo: React.FC = () => {
  return (
    <InfoSection title="About Body Fat Percentage">
      ...
      <p className="mb-2">
        Body fat is essential for health, but the right amount varies by gender, age, and fitness goals. Some body fat is vital for:
      </p>
      ...
      <div className="space-y-2">
        <div>
          ...
          <p className="text-sm">Uses measurements of waist, neck, and hip (for women) circumferences to estimate body fat. It's simple and requires only a tape measure.</p>
        </div>
        
        <div>
          <h4 className="font-medium">Skinfold Measurements</h4>
          <p className="text-sm">Uses calipers to measure the thickness of skin folds at specific body sites. More accurate than circumference methods but requires proper technique.</p>
        </div>
        
        <div>
          <h4 className="font-medium">BMI-based Estimation</h4>
          <p className="text-sm">Uses height, weight, age, and sex to estimate body fat. Less accurate but requires no special equipment.</p>
        </div>
        
        <div>
          <h4 className="font-medium">Professional Methods</h4>
          <p className="text-sm">DEXA scans, hydrostatic weighing, and BodPod measurements provide the most accurate results but require specialized equipment.</p>
        </div>
      </div>
      ...
      <p className="mt-4 text-sm text-gray-600">
        Note that very low body fat percentages can be unhealthy and may lead to health problems. Essential fat is necessary for normal physiological functions.
      </p>
    </InfoSection>
  );
};
