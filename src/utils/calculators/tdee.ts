 ...
 *   Roza & Shizgal. "The Harris Benedict equation reevaluated"
 *   American Journal of Clinical Nutrition, 40(1), 168-182
 *
 * - Katch-McArdle Formula: For individuals with known body fat percentage
...
export function calculateWeightGoals(tdee: number): {
  ...
  return {
    ...
    moderateLoss: Math.max(
      Math.round(tdee + WEIGHT_GOAL_ADJUSTMENTS.moderateLoss),
      minSafeCalories
    ),
