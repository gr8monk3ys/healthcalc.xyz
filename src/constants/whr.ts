...
export const WHR_CATEGORIES: WHRCategory[] = [
  {
    ...
    color: '#10B981', // green
    description:
      'Your waist-to-hip ratio indicates a healthy fat distribution pattern with lower health risks.',
    healthRisk: 'Low',
    ranges: {
      male: { min: 0, max: 0.95 },
      female: { min: 0, max: 0.8 },
    },
  },
  {
    name: 'Moderate Risk',
    color: '#FBBF24', // yellow
    description:
      'Your waist-to-hip ratio indicates a moderate level of abdominal fat, which may increase your health risks.',
    healthRisk: 'Moderate',
    ranges: {
      male: { min: 0.95, max: 1.0 },
      female: { min: 0.8, max: 0.85 },
    },
  },
  {
    name: 'High Risk',
    color: '#F97316', // orange
    description:
      'Your waist-to-hip ratio indicates significant abdominal fat accumulation, which is associated with increased health risks.',
    healthRisk: 'High',
    ranges: {
      male: { min: 1.0, max: 1.1 },
      female: { min: 0.85, max: 0.9 },
    },
  },
  {
    name: 'Very High Risk',
    color: '#EF4444', // red
    description:
      'Your waist-to-hip ratio indicates excessive abdominal fat accumulation, which is strongly associated with metabolic complications and cardiovascular disease.',
