...
const BestRunningShoesWeightLossPageContent = (
  <>
      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            <li>
              <strong>Best for Beginners:</strong> Brooks Ghost 16 ($139.95) - Smooth ride, neutral
              cushion, great out of the box
            </li>
            <li>
            ...
            <li>
              <strong>Best Premium:</strong> New Balance 1080v13 ($159.99) - Fresh Foam X, plush but
              responsive
            </li>
          </ul>
        </div>
        ...
        <p>
          ...
          problem was not running itself but the flat $40 sneakers I was wearing. The right running
          shoe does not make you faster or burn more calories on its own, but it keeps you
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          <p className="mb-4">
            ...
            . But here is the thing: you only burn those calories if you actually run consistently.
            And the number one reason beginners quit running is joint pain from bad shoes.
          </p>
          <p className="mb-4">
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            The Ghost is the best-selling running shoe in America for a reason. It works for almost
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
              <strong>Pros:</strong> Works for most foot types, smooth heel-to-toe transition, good
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            ...
            had shin splints or knee pain from running, try this shoe before you give up on running
            entirely.
          </p>
          <h4 className="font-semibold mt-4 mb-2">Key Features:</h4>
          <ul className="list-disc list-inside space-y-1">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
              <strong>Pros:</strong> Maximum cushion at minimal weight, rocker design reduces joint
              stress, wide toe box, looks good enough to wear casually
            </p>
            <p className="text-sm mt-2">
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            ...
            one-trick pony. Easy runs, tempo runs, occasional 5K races. It handles all of it without
            excelling or failing at anything specific.
          </p>
          <h4 className="font-semibold mt-4 mb-2">Key Features:</h4>
          <ul className="list-disc list-inside space-y-1">
          ...
          <p>
            ...
            paces and do not want to own multiple pairs, the Pegasus covers all your bases. Also the
            cheapest shoe on this list at $130.
          </p>
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            If you overpronate (your feet roll inward when you run), you need a stability shoe. The
          ...
          <h4 className="font-semibold mt-4 mb-2">Who it is best for:</h4>
          <p>
            Overpronators, heavier runners, and anyone who has been told they need a stability shoe.
            Also works well for flat-footed runners. If your old shoes show uneven wear on the
            inside edge, this is your shoe.
          </p>
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <h4 className="font-semibold mt-4 mb-2">Who it is best for:</h4>
          <p>
            Runners who want the plush feel of HOKA with more ground feel and responsiveness. Great
            for long runs, recovery runs, and anyone building up weekly mileage. The wide-size
            options make it ideal for runners with wider feet.
          </p>
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          <p className="mb-4">
            ...
            your big toe) shows more wear than the outside, you likely overpronate and would benefit
            from a stability shoe like the ASICS Gel-Kayano. If the wear is even or slightly on the
            outside, a neutral shoe (Brooks Ghost, HOKA Clifton, Nike Pegasus, or New Balance 1080)
            will work.
          </p>
          <p>
            ...
            thin strip on the outside, you have a neutral or high arch. Track your body metrics with
            our{' '}
...
export default function BestRunningShoesWeightLossPage() {
  return BestRunningShoesWeightLossPageContent;
}
