...
const BodyFatUnderstanding: React.FC = () => {
  ...
  return (
    <InfoSection title="Understanding Body Fat" className="mt-12">
      <p>
        Body fat percentage is a key indicator of health and fitness that goes beyond what a scale
        or BMI can tell you. Understanding your body composition can help you set more meaningful
        fitness goals and track your progress more effectively.
      </p>
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>
          <span className="font-medium">Visceral fat</span> (around organs): Associated with higher
          health risks, including heart disease, type 2 diabetes, and certain cancers
        </li>
        <li>
          <span className="font-medium">Subcutaneous fat</span> (under the skin): Less metabolically
          active and generally poses fewer health risks
        </li>
      </ul>
      <p className="mt-2">
      ...
      <p className="mb-2">To reduce body fat percentage while maintaining or building muscle:</p>
      <ul className="list-disc pl-5 space-y-1">
        <li>
          <span className="font-medium">Resistance training:</span> Helps preserve and build muscle
        ...
        <li>
          <span className="font-medium">Adequate protein:</span> Consume 0.8-1g of protein per pound
          of lean body mass to support muscle preservation
        </li>
        <li>
          <span className="font-medium">Cardiovascular exercise:</span> Helps create a calorie
          deficit and improves heart health
        </li>
        <li>
          <span className="font-medium">Consistency:</span> Body composition changes take time; aim
          for 0.5-1% body fat reduction per month
        </li>
      </ul>

      <h3 className="font-medium mt-4">Limitations of Body Fat Measurements</h3>
      <p className="mb-2">All body fat measurement methods have limitations:</p>
      <ul className="list-disc pl-5 space-y-1">
        <li>
          Navy method and other circumference-based calculations provide estimates that may vary by
          3-5%
        </li>
        <li>
      ...
      <p className="mt-2">
        For the most accurate assessment, use the same measurement method consistently and track
        trends over time rather than focusing on a single measurement.
      </p>
      ...
      <p className="mt-4">
        ...
        ,{' '}
        <Link href={localizePath('/tdee')} className="text-accent hover:underline">
          TDEE Calculator
        </Link>
        , or{' '}
