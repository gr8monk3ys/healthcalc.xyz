...
const UnderstandingABSIPageContent = (
    ...
    <article>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          ...
          predictor of all-cause mortality than BMI, waist circumference, and waist-to-height ratio.
        </p>
        ...
        <p>
          ...
          , the result is typically expressed as a z-score, which compares your value to the average
        ...
        <div className="neumorph p-6 rounded-lg my-8">
          ...
          <ol className="list-decimal pl-6 space-y-2 mb-0">
            ...
            <li>
              ...
              diseases and mortality: a systematic review and meta-analysis. Obes Rev.
              2018;19(5):737-759.
            </li>
            <li>
            ...
            <li>
              ...
              Body Mass Index with a Body Shape Index, Hip Index, and Anthropometric Risk Indicator.
              Metab Syndr Relat Disord. 2018;16(4):160-165.
            </li>
          </ol>
        </div>
      </div>
...
export default function UnderstandingABSIPage() {
  return UnderstandingABSIPageContent;
}
