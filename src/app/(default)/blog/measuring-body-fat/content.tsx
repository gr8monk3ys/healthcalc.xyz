    ...
    <div className="prose prose-lg max-w-none">
      <div className="neumorph p-6 rounded-lg mb-8">
        ...
        <ul className="space-y-2">
          ...
          <li>
            DEXA scans provide the most accurate measurements but are expensive and less accessible
          </li>
          <li>
      ...
      <ul className="list-disc list-inside space-y-3 my-4">
        ...
        <li>
          <strong>Fitness tracking</strong>: Body fat percentage helps distinguish between fat loss
          and muscle loss during weight reduction.
        </li>
        <li>
      ...
      <div className="neumorph p-6 rounded-lg my-4">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Considered the most accurate method available outside of research settings (±1-2% error)
          </li>
      ...
      <div className="neumorph p-6 rounded-lg my-4">
        ...
        <p>
          ...
          multi-frequency devices may achieve ±3-4% accuracy under optimal conditions. The accuracy
          depends heavily on consistent measurement conditions.
        </p>
      ...
      <div className="neumorph p-6 rounded-lg my-4">
        ...
        <h4 className="font-semibold mt-4 mb-2">Accuracy:</h4>
        <p>
          Visual estimation typically has an error range of ±5-9% even when performed by experienced
          professionals. For self-assessment, the error can be even larger. This method is best used
      ...
      <div className="neumorph p-6 rounded-lg my-4">
        ...
        <h4 className="font-semibold mt-4 mb-2">Accuracy:</h4>
        <p>
          The accuracy of 3D scanning for body fat assessment varies significantly depending on the
          system and software. The best systems can achieve accuracy comparable to BIA (±3-5%),
          while others may be less reliable.
        </p>
      </div>
      ...
      <div className="neumorph p-6 rounded-lg my-4">
        <p>
          Several smartphone apps claim to estimate body fat percentage from photos. These typically
          use AI algorithms to analyze body shape and estimate composition.
        </p>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        ...
        <ul className="list-disc list-inside space-y-3">
          <li>
            ...
            absolute measurement? For tracking trends, consistency of method is more important than
            absolute accuracy.
          </li>
          <li>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            Measure at the same time of day (preferably morning, after using the bathroom and before
            eating)
          </li>
      ...
      <ul className="list-disc list-inside space-y-3 my-4">
        ...
        <li>
          <strong>For regular tracking</strong>, consistent use of BIA scales or the Navy Method is
      ...
      <div className="mt-12 border-t pt-8">
        ...
        <ul className="space-y-3 text-sm text-gray-600">
          ...
          <li>
            Fosbol MO, Zerahn B. Contemporary methods of body composition measurement. Clin Physiol
            Funct Imaging. 2015;35(2):81-97.
          </li>
          <li>
          ...
          <li>
            ...
            health and performance, under the auspices of the I.O.C. Medical Commission. Sports Med.
            2012;42(3):227-249.
          </li>
          <li>
...
export default function MeasuringBodyFatPage() {
  return MeasuringBodyFatPageContent;
}
