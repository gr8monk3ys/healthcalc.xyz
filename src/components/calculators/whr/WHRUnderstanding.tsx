  ...
  return (
    <InfoSection title="Understanding Waist-to-Hip Ratio" className="mt-12">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <span className="font-medium">Apple-shaped (higher WHR):</span> Fat is concentrated around the abdomen and waist. This pattern is associated with visceral fat (fat surrounding internal organs) and higher health risks.
        </li>
        <li>
          <span className="font-medium">Pear-shaped (lower WHR):</span> Fat is concentrated around the hips, thighs, and buttocks. This pattern is associated with subcutaneous fat (fat under the skin) and generally lower health risks.
        </li>
      </ul>
      <p className="mt-2">
      ...
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>
          <span className="font-medium">Waist Circumference:</span> Measures abdominal fat directly, but doesn't account for overall body size or frame
        </li>
        <li>
          <span className="font-medium">WHR (Waist-to-Hip Ratio):</span> Compares waist and hip circumferences to assess fat distribution pattern
        </li>
        <li>
          <span className="font-medium">ABSI (A Body Shape Index):</span> Combines waist circumference with height and weight to assess health risk
        </li>
        <li>
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>
          <span className="font-medium">Regular physical activity:</span> Both cardio and strength training can help reduce abdominal fat. High-intensity interval training (HIIT) has been shown to be particularly effective.
        </li>
        <li>
          <span className="font-medium">Balanced diet:</span> Focus on whole foods, lean proteins, fruits, vegetables, and whole grains. Limit processed foods, added sugars, and trans fats.
        </li>
        <li>
          <span className="font-medium">Adequate protein intake:</span> Protein helps preserve muscle mass during weight loss and can increase feelings of fullness.
        </li>
        <li>
          <span className="font-medium">Stress management:</span> Chronic stress can increase cortisol levels, which may promote abdominal fat storage. Techniques like meditation, yoga, or deep breathing can help.
        </li>
        <li>
          <span className="font-medium">Quality sleep:</span> Poor sleep is associated with increased abdominal fat. Aim for 7-9 hours of quality sleep per night.
        </li>
        <li>
          <span className="font-medium">Limit alcohol:</span> Excessive alcohol consumption is associated with increased abdominal fat ("beer belly").
        </li>
      </ul>
      ...
      <p className="mt-4">
        For a more comprehensive health assessment, consider using our other calculators like the <a href="/bmi" className="text-accent hover:underline">BMI Calculator</a>, <a href="/absi" className="text-accent hover:underline">ABSI Calculator</a>, or <a href="/body-fat" className="text-accent hover:underline">Body Fat Calculator</a>.
      </p>
    </InfoSection>
  );
};
