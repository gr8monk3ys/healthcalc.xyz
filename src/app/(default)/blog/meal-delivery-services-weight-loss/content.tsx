...
const MealDeliveryServicesPageContent = (
  <>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          ...
          . Now comes the hard part: actually eating the right amount of calories consistently. Meal
          delivery services can remove the guesswork by providing portion-controlled,
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            ...
            organic, macro-balanced, and designed for specific goals like fat loss, muscle gain, or
            maintenance.
          </p>
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm mt-2">
              <strong>Cons:</strong> Premium pricing, less variety than competitors, meal sizes may
              feel small
            </p>
          </div>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            ...
            protein, carb, and fat content for each meal, making it perfect for specific calorie and
            macro targets.
          </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              <strong>Cooking preference:</strong> Factor/Trifecta for no cooking, HelloFresh if you
              enjoy cooking
            </li>
            <li>
        ...
        <ul className="list-disc list-inside space-y-2 my-6">
          ...
          <li>
            <strong>Learn healthy cooking:</strong> <strong>HelloFresh</strong> - build skills while
            controlling portions
          </li>
          <li>
            <strong>Serious fitness goals:</strong> <strong>Trifecta</strong> - macro-optimized for
            performance
          </li>
          <li>
            <strong>Tight budget:</strong> <strong>MealPro</strong> - affordable with customization
          </li>
        </ul>
...
export default function MealDeliveryServicesPage() {
  return MealDeliveryServicesPageContent;
}
