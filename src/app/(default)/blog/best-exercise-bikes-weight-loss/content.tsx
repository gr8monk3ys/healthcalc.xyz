...
const BestExerciseBikesWeightLossPageContent = (
  <>
      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <strong>Best Compact:</strong> Exerpeutic Folding Magnetic ($199) - Folds to half size
        ...
        <p>
          ...
          . Combine that with the fact that you can hop on a bike in your pajamas at any hour of the
          day, and you have a recipe for actual consistency.
        </p>
        ...
        <ul className="list-disc list-inside my-4 space-y-2">
          ...
          <li>
            <strong>HIIT-friendly:</strong> Interval training on a bike is easier to control than on
            a treadmill, and it keeps burning calories hours after you stop
          </li>
          <li>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mt-2">
            The included heart rate strap is a nice bonus. Most bikes at this price make you buy one
            separately, and knowing your actual heart rate during intervals changes how you train. I
            paired mine with our{' '}
            ...
            grinding away at a steady pace. The magnetic resistance is genuinely silent. I rode this
            at full intensity while my partner slept in the next room. No complaints.
          </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mt-2">
            ...
            50 who started their fitness journey on exactly this kind of bike because it felt
            accessible rather than intimidating. Use our{' '}
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
              <strong>Pros:</strong> Folds for storage, very affordable, comfortable recumbent seat,
              300lb capacity, quiet magnetic resistance, easy to get on and off
            </p>
            <p className="text-sm mt-2">
        ...
        <ul className="list-disc list-inside space-y-2 my-6">
          <li>
            ...
            gives you Peloton-quality rides without the Peloton price tag. The 100 resistance levels
            and Bluetooth connectivity make every ride feel purposeful, and the included heart rate
...
export default function BestExerciseBikesWeightLossPage() {
  return BestExerciseBikesWeightLossPageContent;
}
