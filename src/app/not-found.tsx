...
const popularCalculators = [
  ...
  { name: 'TDEE Calculator', path: '/tdee', description: 'Calculate your Total Daily Energy Expenditure' },
  { name: 'Body Fat Burn Calculator', path: '/body-fat-burn', description: 'Plan your fat loss journey' },
];

// Popular blog posts to show on the 404 page
const popularBlogPosts = [
  { name: 'TDEE Explained', path: '/blog/tdee-explained', description: 'How many calories do you really need?' },
  { name: 'Measuring Body Fat', path: '/blog/measuring-body-fat', description: 'Pros and cons of different methods' },
  { name: 'Calorie Deficit Myths', path: '/blog/calorie-deficit-myths', description: '5 myths about calorie deficits debunked' },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mt-12 p-6 neumorph rounded-lg">
        ...
        <p className="mb-4">
          If you can't find what you're looking for, try one of these options:
        </p>
        <ul className="list-disc list-inside space-y-2 mb-6">
          <li>Check the URL for typos</li>
          <li>Use the navigation menu at the top of the page</li>
          <li>Visit our <Link href="/sitemap" className="text-accent hover:underline">sitemap</Link></li>
        ...
        data={{
          ...
          'itemListElement': [
            ...
            },
            {
              ...
              'position': 2,
              'name': 'Page Not Found',
              'item': 'https://www.healthcheck.com/404'
            }
          ]
        }}
      />
