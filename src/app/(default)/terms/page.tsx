...
export const metadata = {
  title: 'Terms of Service | HealthCalc',
  description: 'HealthCalc terms of service for using our health and fitness calculator tools.',
};
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="neumorph mb-8 rounded-lg p-6">
        ...
        <p>
          By accessing and using HealthCalc, you agree to these Terms. If you do not agree, please
          do not use the site.
        </p>
      </div>
      ...
      <div className="neumorph mb-8 rounded-lg p-6">
        ...
        <p>
          HealthCalc provides informational calculators and educational content related to fitness,
      ...
      <div className="neumorph mb-8 rounded-lg p-6">
        ...
        <p className="mb-3">
          We offer account creation to save calculator results. Authentication is managed by
          Supabase Auth, a secure third-party provider. Saved calculator results may be stored
          locally in your browser and, when you are signed in, synced to our database so you can
      ...
      <div className="neumorph mb-8 rounded-lg p-6">
        ...
        <p>
          Use of HealthCalc does not create a doctor-patient relationship. Content and calculator
      ...
      <div className="neumorph mb-8 rounded-lg p-6">
        ...
        <p>
          To the fullest extent permitted by law, HealthCalc and its operators are not liable for
