...
const BestFitnessAppsPageContent = (
  <>
      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            <li>
              <strong>Best Overall:</strong> MyFitnessPal Premium ($79.99/year) - Largest database,
              most features
            </li>
            <li>
        ...
        <p>
          ...
          target, you need a reliable way to track what you eat. The right app makes the difference
          between guessing and knowing your actual intake.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              <strong>Protein:</strong> Preserves muscle during weight loss (aim for 1.6-2.2g per kg
              body weight)
            </li>
            <li>
            ...
            <li>
              <strong>Fat:</strong> Supports hormones and nutrient absorption (minimum 0.5g per kg)
            </li>
          </ul>
          <p className="mt-4">
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p className="mb-4">
            MyFitnessPal has the largest food database in the world with over 14 million foods. The
            barcode scanner makes logging packaged foods instant, and the recipe importer can pull
            nutrition from any URL.
          </p>
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm mt-2">
              <strong>Cons:</strong> User-submitted entries can be inaccurate, many features require
              premium
            </p>
          </div>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm mt-2">
              <strong>Cons:</strong> Smaller database than MFP, less social features, learning curve
            </p>
          </div>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p>
            ...
            who are just beginning their weight loss journey. The simple interface reduces friction.
          </p>
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm mt-2">
              <strong>Cons:</strong> Database accuracy varies, less detailed than competitors, macro
              tracking limited on free tier
            </p>
          </div>
        </div>
...
export default function BestFitnessAppsPage() {
  return BestFitnessAppsPageContent;
}
