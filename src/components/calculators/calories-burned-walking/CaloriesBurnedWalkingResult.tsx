...
interface CaloriesBurnedWalkingResultProps {
  result: CaloriesBurnedWalkingResult | null;
}

export default function CaloriesBurnedWalkingResult({ result }: CaloriesBurnedWalkingResultProps) {
  if (!result) {
    return (
      <div className="neumorph p-6 rounded-lg">
        <h2 className="text-xl font-semibold mb-2">Calories Burned Walking Result</h2>
        <p className="text-gray-600">Enter your walking details to see results.</p>
      </div>
    );
  }

  return (
    <div id="calories-burned-walking-result" className="neumorph p-6 rounded-lg animate-fade-in">
      <h2 className="text-xl font-semibold mb-4">Calories Burned Walking</h2>
