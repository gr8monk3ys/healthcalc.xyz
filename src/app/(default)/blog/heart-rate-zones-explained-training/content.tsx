...
const HeartRateZonesExplainedPageContent = (
    ...
    <div className="prose prose-lg max-w-none">
      <div className="neumorph p-6 rounded-lg mb-8">
        ...
        <ul className="space-y-2">
          ...
          <li>
            Finding your true max heart rate requires field testing, not just formulas like 220-age
          </li>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        <p>
          Your heart rate is a direct measure of exercise intensity because your heart pumps faster
          to deliver more oxygen to working muscles. The harder you work, the more oxygen your
          muscles need, and the faster your heart beats. By controlling your heart rate, you control
          the intensity and thus the training stimulus.
        </p>
      </div>
      ...
      <h3 className="text-xl font-semibold mt-6 mb-3">Zone 2: Base Building (60-70% of Max HR)</h3>
      ...
      <p>
        ...
        volume without excessive fatigue. You can train more frequently and for longer durations in
      ...
      <p>
        ...
        rate, and the Karvonen method (heart rate reserve). They produce different numbers, and for
        most people, the Karvonen method is more accurate.
      </p>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            ...
            Still has significant individual variation.
          </li>
          <li>
            <strong>211 minus (0.64 × age)</strong>: Developed specifically for trained individuals.
            Better for athletes.
          </li>
        </ul>
      </div>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        ...
        <ol className="list-decimal list-inside space-y-3">
          ...
          <li>
            <strong>Perform a 3-minute hard effort</strong> at about 90% of your estimated max heart
            rate
          </li>
          <li>
      ...
      <p>
        The most common training mistake is making easy days too hard and hard days not hard enough.
        You end up chronically fatigued without adequate stimulus for maximum adaptation.
      </p>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            <strong>15-20% of training time</strong> in Zone 4-5 (hard intervals and threshold work)
          </li>
          <li>
      ...
      <div className="neumorph p-6 rounded-lg my-4">
        <p>
          ...
          caffeine, and fatigue all affect heart rate. Sometimes your heart rate will be higher than
          expected for a given effort. Sometimes lower. Use perceived exertion and pace as secondary
          indicators. If your heart rate seems off, trust your body.
        </p>
      </div>
      ...
      <h3 className="text-xl font-semibold mt-6 mb-3">7. Forgetting About Progressive Overload</h3>
      ...
      <div className="neumorph p-6 rounded-lg my-6">
        <ol className="list-decimal list-inside space-y-3">
          <li>
            <strong>Test or estimate your max heart rate accurately.</strong> Formulas are starting
            points. Field testing is better.
          </li>
          <li>
          ...
          <li>
            <strong>Make your easy days truly easy.</strong> Stay in Zone 1-2 even when it feels too
            slow.
          </li>
          <li>
          ...
          <li>
            <strong>Be patient with progress.</strong> Aerobic adaptations take weeks to months, not
            days.
          </li>
          <li>
      ...
      <div className="neumorph p-6 rounded-lg mt-8">
        ...
        <p className="mb-4">
          Use our heart rate calculators to determine your target zones and optimize your training:
        </p>
        <ul className="list-disc list-inside space-y-2">
          <li>
...
export default function HeartRateZonesExplainedPage() {
  return HeartRateZonesExplainedPageContent;
}
