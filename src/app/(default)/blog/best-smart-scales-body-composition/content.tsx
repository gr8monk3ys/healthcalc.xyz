...
const BestSmartScalesPageContent = (
  <>
      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <strong>Best Mid-Range:</strong> Eufy Smart Scale P2 Pro ($69.99) - 16 metrics with 3D
              body model
            </li>
            <li>
        ...
        <p>
          ...
          , you know how important accurate measurements are for tracking your health journey. While
          our calculators provide excellent estimates using proven formulas, a smart scale can give
          you daily tracking data and help you monitor trends over time.
        </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              <strong>Multi-User Support:</strong> Important for families - look for automatic user
              recognition
            </li>
          </ul>
        </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
              <strong>Pros:</strong> Excellent accuracy, comprehensive metrics, no subscription for
              core features, beautiful design
            </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm mt-2">
              <strong>Cons:</strong> Bluetooth only (need phone nearby), body fat accuracy slightly
              lower than premium options
            </p>
          </div>
          <div className="mt-4">
            <a
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">How Smart Scales Measure Body Composition</h2>
        ...
        <ul className="list-disc list-inside space-y-2 my-6">
          <li>
            <strong>Invest in accuracy:</strong> Get the <strong>Withings Body Smart</strong> if you
            want the most reliable data and can afford the premium
          </li>
          <li>
          ...
          <li>
            <strong>Middle ground:</strong> The <strong>Eufy P2 Pro</strong> offers premium features
            (Wi-Fi, 16 metrics) at a mid-range price
          </li>
        </ul>
...
export default function BestSmartScalesPage() {
  return BestSmartScalesPageContent;
}
