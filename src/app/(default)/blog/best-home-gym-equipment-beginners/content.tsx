...
const BestHomeGymEquipmentPageContent = (
  <>
      ...
      <div className="prose prose-lg max-w-none">
        <div className="neumorph p-6 rounded-lg mb-8">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <strong>Best Adjustable Dumbbells:</strong> Bowflex SelectTech 552 ($429.00) - Replace
              15 pairs of dumbbells
            </li>
            <li>
            ...
            <li>
              <strong>Best Kettlebell:</strong> Amazon Basics Cast Iron Kettlebell ($28.08) - Solid
              build, great starting weight
            </li>
            <li>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm">
              <strong>Pros:</strong> Incredibly affordable, travel-friendly, versatile for full-body
              workouts, beginner-safe
            </p>
            <p className="text-sm mt-2">
              <strong>Cons:</strong> Limited resistance ceiling for advanced lifters, latex can wear
              over time with heavy use
            </p>
          </div>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <p>
            ...
            the ground, a high-quality mat makes a noticeable difference in comfort and safety.
          </p>
          ...
          <p>
            ...
            to track how many calories you burn during yoga, Pilates, or bodyweight sessions on your
            mat.
          </p>
        ...
        <div className="neumorph p-6 rounded-lg my-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              ...
              movement patterns - push, pull, hinge, squat, and cardio - so beginners get a complete
              training foundation
            </li>
            <li>
              <strong>Beginner Friendliness:</strong> Every item has a low learning curve and can be
              used safely without a spotter or specialized knowledge
            </li>
            <li>
        ...
        <ul className="list-disc list-inside space-y-2 my-6">
          ...
          <li>
            <strong>For the complete package:</strong> All six items together cost less than a year
            at most gyms and give you everything needed for a well-rounded program
          </li>
        </ul>
...
export default function BestHomeGymEquipmentPage() {
  return BestHomeGymEquipmentPageContent;
}
