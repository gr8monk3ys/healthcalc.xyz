...
const CardioVsWeightsFatLossContentContent = (
  <article className="max-w-4xl mx-auto px-4 py-12">
    ...
    <div className="prose prose-lg dark:prose-invert max-w-none">
      ...
      <p>
        When you add all of that together, the metabolic advantage of carrying more muscle is real.
        Not as dramatic as the fitness industry suggests, but meaningful enough to matter over
        months and years.
      </p>
      ...
      <div className="neumorph-card rounded-xl p-6 my-8 bg-green-50 dark:bg-green-900/20">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Want to know how many calories you burn at rest and with activity? Use our calculators to
      ...
      <p>
        The research here is unambiguous. People who diet without resistance training lose both fat
        and muscle. People who diet with resistance training lose mostly fat while maintaining (or
        even building) muscle.
      </p>
      ...
      <p>
        That last one matters more than people admit. Creating a calorie deficit through diet alone
        is hard. Really hard. Being hungry all the time makes you miserable, kills your training
        performance, and eventually leads to binges.
      </p>
      ...
      <p>
        ...
        demands it (though it does support it), but because variety keeps things interesting. Doing
        the same thing every day gets boring. Boredom kills adherence faster than anything else.
      </p>
      ...
      <ol className="space-y-3">
        ...
        <li>
          <strong>Cardio makes it easier to maintain a calorie deficit.</strong> More activity means
...
export default function CardioVsWeightsFatLossContent() {
  return CardioVsWeightsFatLossContentContent;
}
