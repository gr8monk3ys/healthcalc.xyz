...
const HowToMeasureBodyFatAtHomeContentContent = (
  <article className="max-w-4xl mx-auto px-4 py-12">
    ...
    <div className="prose prose-lg dark:prose-invert max-w-none">
      <p className="text-xl text-gray-700 dark:text-gray-300 mb-6">
        I spent years obsessing over the number on my bathroom scale. Then I started measuring body
        fat and realized I had been tracking the wrong thing entirely. Two people can weigh exactly
        the same and look completely different. The difference is body composition.
      </p>
      ...
      <p>
        ...
        percentage down to the decimal. The goal is to pick a method, use it consistently, and track
        the trend over time. The trend matters far more than any single measurement.
      </p>
      ...
      <p>
        ...
        measure, and takes about two minutes. The U.S. Navy developed this formula to estimate body
        fat for thousands of service members without expensive equipment, and it holds up
        surprisingly well.
      </p>

      <p>
        The Navy method uses circumference measurements at specific body sites to estimate body fat
        percentage. The formula is different for men and women because fat distribution patterns
      ...
      <ol className="space-y-3">
        ...
        <li>
          <strong>Waist circumference.</strong> At the narrowest point of the natural waist, usually
          just above the belly button. Relax, breathe out normally, then measure.
        </li>
        <li>
      ...
      <p>
        ...
        formula can be off by more. It also tends to underestimate body fat in very lean individuals
        and overestimate in those with a lot of muscle mass around the neck and shoulders.
      </p>
      ...
      <p>
        ...
        your overall body fat. More fat under the skin means more total fat. The relationship is not
        perfect, because some people store more fat viscerally (around organs) than subcutaneously
        (under skin), but it is consistent enough to be useful.
      </p>
      ...
      <p>
        This is the most common approach for home use because it requires fewer measurements and is
      ...
      <ol className="space-y-2">
        ...
        <li>
          <strong>Thigh.</strong> A vertical fold on the front of the thigh, midway between the hip
          and knee.
        </li>
      </ol>
      ...
      <ol className="space-y-2">
        <li>
          <strong>Tricep.</strong> A vertical fold on the back of the upper arm, midway between the
          shoulder and elbow.
        </li>
        <li>
      ...
      <p>
        ...
        subscapular (below the shoulder blade), abdomen, suprailiac, and thigh. It is more accurate
        because it captures fat distribution across more of the body, but it is nearly impossible to
        do on yourself. You need a partner.
      </p>
      ...
      <p>
        Your hydration level has a massive impact on the reading. Drink two glasses of water before
        stepping on and your body fat reading drops. Exercise that morning? Reading goes up because
        you are dehydrated. Had a salty meal last night? You are retaining water, and the reading
        drops again.
      </p>
      ...
      <p>
        Despite the accuracy issues, smart scales have one big advantage: convenience. You are going
        to weigh yourself anyway. If the scale also gives you a body fat estimate with zero extra
        effort, that is still useful data, as long as you understand its limitations. Want
      ...
      <p>
        This one is the simplest and the least precise. You look at yourself in a mirror and compare
        what you see to reference photos of people at known body fat percentages.
      </p>
      ...
      <p>
        ...
        you are getting leaner. You know if your abs are becoming more visible. You notice when your
        face gets more defined or your arms look more toned.
      </p>
      ...
      <p>
        Here is an honest look at how each home method stacks up. I am comparing everything against
        DEXA scanning, which is considered the gold standard (though even DEXA has about a 1 to 2
      ...
      <p>
        Looking at this table, the Navy method and calipers come out on top for home use. Both offer
        reasonable accuracy at minimal cost. The Navy method wins on ease of use. Calipers win on
        accuracy if you develop good technique.
      </p>

      <p>
        Smart scales lose on accuracy but win on convenience. If you are already stepping on a scale
        every day, you are getting data for free. Just do not read too much into any single number.
      </p>
      ...
      <p>
        ...
        pounds of actual fat per week. On a 180-pound person, that is less than a 1% change in body
        fat percentage. Most home methods cannot reliably detect that small a change in a single
        measurement.
      </p>
      ...
      <ul className="space-y-3">
        ...
        <li>
          <strong>Smart scale:</strong> Daily, but only track the 7-day rolling average. Any single
          day reading is too noisy to be meaningful. The trend line of your weekly average is what
          you want.
        </li>
        <li>
      ...
      <ol className="space-y-3">
        ...
        <li>
          <strong>Record your raw measurements, not just the calculated percentage.</strong> If you
          use the Navy method, write down your neck, waist, and hip measurements. If you use
      ...
      <p>
        ...
        medicine clinics, and specialized body composition facilities offer them. If you have never
        had one, getting a single baseline DEXA scan is genuinely useful. It gives you a reliable
        reference point to compare your home measurements against.
      </p>
      ...
      <ul className="space-y-2">
        <li>You are starting a serious body recomposition program and want a reliable baseline.</li>
        ...
        <li>You carry fat in atypical patterns and suspect home methods are inaccurate for you.</li>
      </ul>

      <p>
        For most people, a DEXA scan once or twice a year combined with monthly home measurements is
        plenty. You do not need professional testing to know whether your body composition is
      ...
      <ol className="space-y-3">
        <li>
          <strong>Start with the Navy method.</strong> It is cheap, easy, and accurate enough. Grab
          a tape measure and use our{' '}
        ...
        <li>
          ...
          weight, body fat percentage (method used), tape measurements, and notes about how you look
          and feel. Over months, this becomes incredibly valuable data.
        </li>
      </ol>

      <p>
        The mistake most people make is not measuring at all, or measuring obsessively and panicking
        over normal day-to-day variation. Find a middle ground. Consistent monthly check-ins with a
        reliable method will tell you everything you need to know about whether your training and
        nutrition are working.
      </p>
...
export default function HowToMeasureBodyFatAtHomeContent() {
  return HowToMeasureBodyFatAtHomeContentContent;
}
